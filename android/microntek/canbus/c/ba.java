...
public class ba extends a
{
  ...
  public ba(CanBusServer paramCanBusServer, Context paramContext)
  {
      ...
      if (paramArrayOfByte[(paramInt1 + 2)] == 5)
      {
        ...
        if ((i != 0) && ((0x10 & arrayOfByte13[1]) != 0))
        {
          ...
          if (paramArrayOfByte[(paramInt1 + 2)] == 2)
          {
            ...
            continue;
            if ((paramArrayOfByte[(paramInt1 + 2)] == 5) && (goto 140) && (paramArrayOfByte[(paramInt1 + 2)] == 1) && (goto 140) && (this.e != 42) && (paramArrayOfByte[(paramInt1 + 2)] == 5) && (this.cv.l() != 0))
            {
              ...
              this.cv.a(this.aY);
              continue;
              if ((this.e != 42) && (paramArrayOfByte[(paramInt1 + 2)] == 4) && (this.cv.l() != 0))
              {
 ...
 * Qualified Name:     android.microntek.canbus.c.ba
