...
{
  public bg(CanBusServer paramCanBusServer, Context paramContext)
  {
  ...
  public void d(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      if (paramArrayOfByte[(paramInt1 + 2)] >= 2)
      {
        ...
        if (paramArrayOfByte[(paramInt1 + 2)] >= 2)
        {
          int i = (0xFF & paramArrayOfByte[(paramInt1 + 3)]) << 8 | 0xFF & paramArrayOfByte[(paramInt1 + 4)];
          if (i > 32768)
            i += 0;
          o(0 - i * 30 / 5445);
        }
 ...
 * Qualified Name:     android.microntek.canbus.c.bg
